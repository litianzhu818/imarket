...
{
    [super viewDidLoad];
    [self setNavigationBarTitle:@"购物一览"];
    ...
    if (self.collectionViewLayoutClass) {
        ...
        self.calendarCollectionView = [[CALAgendaCollectionView alloc] initWithFrame:CGRectMake(0, 64, self.view.frame.size.width, self.view.frame.size.height-64) collectionViewLayout:self.collectionMonthLayout];
